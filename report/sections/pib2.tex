...
RIMUOVERE L'ELENCO DEI MODULI SOTTO E CONTINUARE CON IL DISCORSO COUESO SEGUENDO IL FLUSSO DEL
CODICE DANDO LA PRECEDENTE DESCRIZIONE DELLA NOSTRA IMPLEMENTAZIONE DI RAFT PER ASSODATA E 
QUINDI FOCALIZZANDOSI SOLO SULLA NOSTRA LOGICA AGGIUNTIVA.
...
\subsubsection{il nodo riceve una richiesta RPC\\}
...
l'RPC e' stata inviata nel channel che ha scatenato l'inizio della goroutine per gestirlo,
