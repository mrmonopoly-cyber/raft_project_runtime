...
\begin{itemize}
    ...
    \item \textbf{CommonMatchIndex}:
        ...
        Questo sistema è necessario alle singole configurazioni per comunicare al gestore delle configurazioni che hanno committato 
        una nuova entry: in questo modo il gestore delle configurazioni può procedere ad incrementare il commit 
        globalmente. Tutto questo procedimento è infine effettuato solamente dal leader per aggiornare il commit index.  
